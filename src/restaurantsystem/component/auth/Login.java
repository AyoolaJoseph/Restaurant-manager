...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        loginPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Ayoola's Delight Restaurant", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lucida Grande", 0, 13), new java.awt.Color(0, 0, 204))); // NOI18N
        ...
        passwordLabel.setForeground(new java.awt.Color(0, 0, 201));
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        if (userNameField.getText().equalsIgnoreCase("AYOBAMI")) {
            JOptionPane.showMessageDialog(this, "Access granted");
            this.dispose();
            MainMenu mainMenu = new MainMenu();
            mainMenu.setVisible(true);
        } else {
            userNameField.setText("AYOBAMI");
